//This text was basically machine translated by DeepL pro.
//And thanks to Jetrotal's reference file, entirely enhanced. Now command names on this file are fit to what are on RM editor  - TkHuskarl, 27.3.23
<details>
...
### ◆ Screen zoom <a id='Screen Zoom'></a>
    @scr.weather
...
//From Jetrotal's reference. - TkHuskarl
...
//This one is also from Jetrotal's reference.
...
"
    ...
    */
    ...
    .extract Variable expansion in string
		...
		// will this remove what is cut in the base string?
