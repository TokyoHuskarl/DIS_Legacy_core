...
### 総論
  ...
  - シールドウォールの変更
    - 性能変更
      - シールドウォール中のユニットは矢弾の防御確率が非常に高くなるように変更。
    - オーラ効果の追加
...
- スキル範囲外を指定した際に表示されていたインディケーターがv1.162BETAになってから出なくなっていたのを修正（BETA2fix4）
- BETA2fix3から経路探索が動かなくなっていたのを修正(BETA2fix4)
