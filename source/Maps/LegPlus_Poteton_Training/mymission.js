/**
 * A very small stage that ends in 2 minutes.
 * Potetons vs Imperial Aux
 * @mission Poteton_Training
 */
{
	// isnt this rewritten?
	RTS.Preserve.test_veryimportantagent = 0;
	...
	// 
	const loop_enMove = RTS.mission.createSimpleTrigger_Loop(500);
	loop_enMove.effect = ()=> {
	...
	*/
	...
	const loop_gameend = RTS.mission.createSimpleTrigger_Loop(500);
	loop_gameend.effect = function() {
		// player victory
	...
	RTS.mission.startup = function(){
		RTS.mission.setTrigger(trig1);
		RTS.mission.setTrigger(trig2);
		//Ally
		//犠牲者十人未満はいける
