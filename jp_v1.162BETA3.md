...
９月~~中ごろ~~後半の正式リリースが目標。ステージ追加以外は大して変わりません。
...
- テクノロジー・建物・勢力のjs制御？（気合い入れて解読すれば勢力等々を追加できる感じで）
...
### 総論
  - Maniacs Patchバージョン更新
	...
	- 世界に存在可能な最大ユニット数を845->890に拡張。
		- このバージョンから最大990まで対応する予定です。メモリ割当の関係上細かな工事が必要なので、完了次第逐次拡張していく形に……
...
- 地形データをcsvで管理するように変更。
- ピック可能な勢力の設定・~Perk定義csv~をModule内に格納し、将来的にいじりやすいように変更。
