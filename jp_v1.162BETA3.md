# DIS:Legacy v1.162BETA4
# Update: "EQUITES PORRO" - Proto
内部的なシステムが大幅に組み替えられたためバグりがちです。何か見つけたら報告お願いします。  
絶賛リリース期日延期中！  

#### **v1.162正式リリースまでのロードマップ：**
- 細かな不具合潰しとUI周りの細かな再編
- **ステージ追加(むりかも)**  
  
~~９月中ごろから後半~~１０月~~１１月初旬の正式リリースが目標。  
あと本当にもう少し…  
...
- 100体以上のグリーンスキン兵士によるバンザイチャージがバグるかも
- 「帝国装甲騎兵」の動きがおかしい  
  面白いからそのままにするかも。  
- 登録部隊の経路探索がセーブロードするとおかしくなることがある/バラバラに動いてしまう（組換え中）
