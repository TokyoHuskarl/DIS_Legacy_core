...
- スキル「モードチェンジ」を通して、超長射程の砲撃を行う攻撃モードと攻撃能力を一切持たない移動モードを切り替えて運用する攻城ユニットです。  
  ゲーム中最高の射程を持ち、建物に対して凄まじい破壊力を発揮します。  
...
- ボンバルドラ・ギャオンの変更
  - 攻撃力を+3、移動速度を+5増加。  
   ...
   攻撃力増加は調整への補填というよりキリのいい数字にするためのものでしかなく、単発威力的では人間の大砲よりもかなり劣ります。
- ユニットステータス変更表  
...
- ユニットの当たり判定計算において、弾に対する当たり判定が想定よりも小さくなっていた不具合を修正。  
  壁に弾が当たったり当たらなかったりするやつの主な原因はおそらくこれです。
